...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onResume() {
        super.onResume();
        customAdapter.updateData(appDatabase.contactClassDao().getAllContacts());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new CustomAdapter(list, this, appDatabase, mMap);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addContactIntent = new Intent(getApplicationContext(), AddContact.class);
                addContactIntent.putExtra("List", (Serializable) list);
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)).position(userLocation).title("Your Location")).setTag(101);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(this, "You need to allow to use the app.", Toast.LENGTH_SHORT).show();
    ...
    public void addPins() {
        ...
        for (i = 0; i < list.size(); i++) {
            LatLng userLocation = new LatLng(list.get(i).latitude, list.get(i).longitude);
            mMap.addMarker(new MarkerOptions().position(userLocation).title(list.get(i).name)).setTag(list.get(i).tag);
